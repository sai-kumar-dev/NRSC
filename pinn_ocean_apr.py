...
def main():
    ...
    try:
        ...
        config = {
            'data_file': '/projects/nrsc01/air-sea_flux/data/era5_april_1995_2024_complete.nc',
            'batch_size': 2048,
            'hidden_dim': 128,
            'num_layers': 4,
            'num_epochs': 70, 
...
def run_comprehensive_analysis():
    ...
    try:
        ...
        data_file = "/projects/nrsc01/air-sea_flux/data/era5_april_1995_2024_complete.nc"  # Replace with actual path
